...
Au = fcc111(symbol='Au',a=4.15402,size=(2,2,5),vacuum=10)# Using optimized lattice constant to build Au_fcc111 surface with 5 layers of Au 
...
calc4 = Vasp(xc='PBE', #Level of theory (density functional)
            ...
            kpts=[2,2,1], #number of k-points, e.g. [3,3,3] (convergence test; fewer kpoints are needed if lattice dimension is large)
